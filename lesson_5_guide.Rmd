...
IBL %>%
  ...
  annotate(geom = "text", x = xintercept - 50, y = 15, label = "Only Current Consumption") +
  annotate(geom = "text", x = 50, y = yintercept + 15, label = "Only Future Consumption") +
  annotate(geom = "text", x = nlnbc1 + 25, y = nlnbc2 + 25, label = "No Lending/No Borrowing")
```
